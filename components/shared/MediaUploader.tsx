...
const MediaUploader = ({
  ...
  return (
    <CldUploadWidget uploadPreset='Aisaas' options={{multiple: false, resourceType: "image"}} onSuccess={onUploadSuccessHandler} 
    onError={onUplaodErrorHandler}>
        {({open})=> (
